...
/// <see cref="Confirmed"/>. S-05 will *append* <c>Unclaimed</c> / <c>SentBack</c> without restructuring the
/// log. Persisted as a readable string so the audit trail stays legible.
/// </summary>
